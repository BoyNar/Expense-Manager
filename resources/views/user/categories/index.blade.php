                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('user.category.edit', encrypt( $category->id))}}">{{ __('Edit') }}</a>
                                                        <a class="dropdown-item" onclick="confirm_modal('{{route('user.category.destroy',  $category->id)}}');">{{ __('Delete') }}</a>
                                                    </div>
                                                </div>
