                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('user.expense.edit', encrypt( $expense->id))}}">{{ __('Edit') }}</a>
                                                        <a class="dropdown-item" onclick="confirm_modal('{{route('user.expense.destroy',  $expense->id)}}');">{{ __('Delete') }}</a>
                                                    </div>
                                                </div>
